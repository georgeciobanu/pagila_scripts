...
--
-- Name: payment_customer_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_customer_id_idx ON public.payment USING btree (customer_id);
--
-- Name: idx_fk_payment_staff_id; Type: INDEX ATTACH; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.payment
    ADD CONSTRAINT payment_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(staff_id);
